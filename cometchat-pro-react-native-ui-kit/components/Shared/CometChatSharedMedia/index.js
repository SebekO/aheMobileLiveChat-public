        ...
        <View style={[styles.sectionContentStyle]}>
          <View style={styles.mediaBtnStyle}>
            <TouchableOpacity
              ...
              <Text style={styles.buttonTextStyle}>Zdjęcia</Text>
            </TouchableOpacity>
            {messageType === CometChat.MESSAGE_TYPE.FILE ? (
            ...
            <TouchableOpacity
              ...
              <Text style={styles.buttonTextStyle}>Filmy</Text>
            </TouchableOpacity>
            {messageType === CometChat.MESSAGE_TYPE.IMAGE ? (
              <View style={styles.separator} />
            ) : null}
            <TouchableOpacity
              ...
              <Text style={styles.buttonTextStyle}>Pliki</Text>
            </TouchableOpacity>
          </View>
          <FlatList
            data={messages}
