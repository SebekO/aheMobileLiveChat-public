...
export default class CometChatBanGroupMemberList extends React.Component {
  ...
  constructor(props) {
    ...
    this.decoratorMessage = 'Wczytywanie...';
  ...
  listHeaderComponent = () => {
    return (
      <View style={[style.contactHeaderStyle]}>
        <Text style={style.contactHeaderTitleStyle}>Zbanowani użytkownicy</Text>
      </View>
    );
  };
  ...
  render() {
    ...
    if (!membersList.length) {
      this.decoratorMessage = 'Brak zablokowanych członków';
    }
    return (
      <React.Fragment>
        <Modal
